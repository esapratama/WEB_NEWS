            ...
            <?php if (count($newsList) > 0 && !$searchQuery && !$categoryFilter): ?>
                ...
                <div class="col-md-6">
                    <div class=" text-white">
                        ...
                        <?php else: ?>
                            <img src="https://placehold.co/300x200" class="card-img" alt="Placeholder Image" style="border-radius: 8px;">
                        <?php endif; ?>
                    </div>
                </div>
                                    ...
                                    <?php if (!$categoryFilter || $news['category'] === $categoryFilter): ?>
                                        <div class="col-md-3 mb-4">
                                            <div class="card">
                                                ...
                                                <?php if ($imageUrl && in_array(strtolower($fileExtension), ['jpg', 'jpeg', 'png', 'gif', 'webp'])): ?>
                                                    <img src="<?= $imageUrl ?>" class="card-img-top" style="object-fit: cover; height: 240px; width: 100%; border-radius: 8px;" alt="News Image">
                                                <?php elseif ($imageUrl && in_array(strtolower($fileExtension), ['mp4', 'webm', 'ogg'])): ?>
                                                    <video class="card-img-top" style="object-fit: cover; height: 240px; width: 100%; border-radius: 8px;" controls muted>
                                                        <source src="<?= $imageUrl ?>" type="video/<?= $fileExtension ?>">
                                                        Your browser does not support the video tag.
                                                    </video>
                                                <?php else: ?>
                                                    <img src="https://placehold.co/300x200" class="card-img-top" style="object-fit: cover; height: 240px; width: 100%; border-radius: 8px;" alt="Placeholder Image">
                                                <?php endif; ?>
                                                <div class="card-body">
                                ...
                                <div class="card ">
                                    <a href="detail.php?id=<?= $news['_id'] ?>" class="text-decoration-none text-black">
                                        ...
                                        <?php if (in_array(strtolower($fileExtension), ['jpg', 'jpeg', 'png', 'gif', 'webp'])): ?>
                                            <img src="<?= $imageUrl ?>" class="card-img-top" height="200rem" width="100%" style="object-fit: cover;" alt="News Image">
                                        <?php elseif (in_array(strtolower($fileExtension), ['mp4', 'webm', 'ogg'])): ?>
                                            <video class="card-img-top" height="200rem" style="width: 100%; object-fit: contain;" controls muted>
                                                <source src="<?= $imageUrl ?>" type="video/<?= $fileExtension ?>">
                                                Your browser does not support the video tag.
                                            </video>

                                        <?php else: ?>
                                            <img src="<?= $imageUrl ?>" class="card-img-top" height="200rem" style="object-fit: cover;" alt="Placeholder Image">
                                        <?php endif; ?>
                ...
                <div class="container  my-4">
                    ...
                    <div class="video mt-4">
                        ...
                        <div class="card position-relative" style="height: 30rem;">
                            ...
                            <?php if (in_array(strtolower($fileExtension), ['jpg', 'jpeg', 'png', 'gif', 'webp'])): ?>
                                <img src="<?= $imageUrl ?>" class="card-img-top img-fluid" style="object-fit: cover; height: 100%; border-radius: 4px;" alt="News Image">
                            <?php elseif (in_array(strtolower($fileExtension), ['mp4', 'webm', 'ogg'])): ?>
                                <video class="card-img-top img-fluid" style="object-fit: contain; height: 100%; border-radius: 4px;" controls muted>
                                    <source src="<?= $imageUrl ?>" type="video/<?= $fileExtension ?>">
                                    Your browser does not support the video tag.
                                </video>
                            <?php else: ?>
                                <img src="<?= $imageUrl ?>" class="card-img-top img-fluid" style="object-fit: cover; height: 100%; border-radius: 4px;" alt="Placeholder Image">
                            <?php endif; ?>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card">
                                    <a href="detail.php?id=<?= $news['_id'] ?>" class="text-decoration-none text-black">
                                        ...
                                        <?php if (in_array(strtolower($fileExtension), ['jpg', 'jpeg', 'png', 'gif', 'webp'])): ?>
                                            <img src="<?= $imageUrl ?>" class="card-img-top" style="object-fit: cover; height: 300px; width: 100%;" alt="News Image">

                                        <?php elseif (in_array(strtolower($fileExtension), ['mp4', 'webm', 'ogg'])): ?>
                                            <video class="card-img-top" style="width: 100%; height: 300px; object-fit: contain;" controls muted>
                                                <source src="<?= $imageUrl ?>" type="video/<?= $fileExtension ?>">
                                                Your browser does not support the video tag.
                                            </video>
                                        <?php else: ?>
                                            <img src="<?= $imageUrl ?>" class="card-img-top" style="object-fit: cover; height: 200rem;" alt="Placeholder Image">
                                        <?php endif; ?>
                                        <div class="card-body">
                                            <span class="badge bg-danger mb-2"><?= htmlspecialchars($news['category']) ?></span>
                                            <h5 class="card-title card-text-custom fw-semibold"><?= $news['title'] ?></h5>
                                    ...
                                    <div class="col-md-4 text-end">
                                        ...
                                        <?php if (in_array(strtolower($fileExtension), ['jpg', 'jpeg', 'png', 'gif', 'webp'])): ?>
                                            <img src="<?= $imageUrl ?>" class="card-img-top img-fluid float-end"
                                                style="object-fit: cover; border-radius: 10px; float: right; height: 13rem;" alt="News Image">
                                        <?php elseif (in_array(strtolower($fileExtension), ['mp4', 'webm', 'ogg'])): ?>
                                            <video class="card-img-top img-fluid float-end"
                                                style="object-fit: contain; border-radius: 10px; float: right; height: 13rem; width: 100%;" controls muted>
                                                <source src="<?= $imageUrl ?>" type="video/<?= $fileExtension ?>">
                                                Your browser does not support the video tag.
                                            </video>
                                        <?php else: ?>
                                            <img src="<?= $imageUrl ?>" class="card-img-top img-fluid float-end"
                                                style="object-fit: cover; border-radius: 10px; float: right; height: 13rem;" alt="Placeholder Image">
                                        <?php endif; ?>
                                    </div>
                                    <hr class="mt-4 mb-4">
                                </div>
